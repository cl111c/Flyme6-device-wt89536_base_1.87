...
.method private setBackground(Landroid/content/res/TypedArray;Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;ZZZ)V
    ...
    .local v20, "needsDefaultBackgrounds":Z
    if-eqz v20, :cond_0

    const v11, #android:drawable@popup_full_dark#t

    const v26, #android:drawable@popup_top_dark#t
    ...
    const v25, #android:drawable@popup_top_bright#t
    ...
    .line 811
    .local v28, "views":[Landroid/view/View;
    const/16 v29, 0x4
    ...
    .line 817
    aput-object p2, v28, v21

    .line 818
    const/16 v29, 0x0

    aput-boolean v29, v15, v21
    ...
    invoke-virtual {v0, v8, v1}, Landroid/widget/ListView;->setItemChecked(IZ)V
    ...
    sget-object v30, Lcom/android/internal/R$styleable;->Theme:[I

    invoke-virtual/range {v29 .. v30}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;
    ...
    const v30, #android:integer@tct_spinner_max_items#t
    ...
    const v30, #android:dimen@tct_list_item_height#t
    ...
    const v30, #android:id@buttonPanel#t

    invoke-virtual/range {v29 .. v30}, Landroid/view/Window;->findViewById(I)Landroid/view/View;

    move-result-object v19

    .line 899
    .local v19, "localView":Landroid/view/View;
    if-eqz v19, :cond_e
    ...
    .line 904
    .local v18, "localListAdapter":Landroid/widget/ListAdapter;
    if-eqz v18, :cond_f
    ...
    .line 905
    invoke-virtual/range {v16 .. v16}, Landroid/widget/ListView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;

    move-result-object v17

    .line 906
    .local v17, "localLayoutParams":Landroid/view/ViewGroup$LayoutParams;
    mul-int v29, v9, v12
    ...
    .end local v17    # "localLayoutParams":Landroid/view/ViewGroup$LayoutParams;
    .end local v18    # "localListAdapter":Landroid/widget/ListAdapter;
    .end local v19    # "localView":Landroid/view/View;
    :cond_f
    return-void

    .end local v16    # "listView":Landroid/widget/ListView;
    .end local v23    # "style":Z
...
.method private setupView()V
    ...
    sget-object v26, Lcom/android/internal/R$styleable;->Theme:[I
    ...
    .line 555
    .local v25, "ta":Landroid/content/res/TypedArray;
    const/16 v4, 0x143
    ...
    .end local v24    # "style":Z
    .end local v25    # "ta":Landroid/content/res/TypedArray;
    :cond_5
    move-object/from16 v0, p0
    ...
    .restart local v24    # "style":Z
    .restart local v25    # "ta":Landroid/content/res/TypedArray;
    :cond_b
    if-eqz v10, :cond_c
    ...
    .restart local v21    # "indicators":I
    goto :goto_5
