...
.method static synthetic access$1500(Landroid/content/Context;)Z
    ...
    .prologue
    .line 71
    invoke-static {p0}, Lcom/android/internal/widget/FloatingToolbar;->useTctThemeStyle(Landroid/content/Context;)Z
...
.method private static createMenuItemButton(Landroid/content/Context;Landroid/view/MenuItem;)Landroid/view/View;
    ...
    .line 1484
    .end local v1    # "menuItemButton":Landroid/widget/Button;
    :cond_1
    invoke-static {p0}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;
    ...
    .restart local v1    # "menuItemButton":Landroid/widget/Button;
    goto :goto_1
.end method
...
.method private static useTctThemeStyle(Landroid/content/Context;)Z
    .locals 6
    .param p0, "context"    # Landroid/content/Context;
    ...
    invoke-virtual {p0, v3, v4, v5, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v1

    .line 1597
    .local v1, "va":Landroid/content/res/TypedArray;
    const/16 v3, 0x58
