...
.method private getPackageLPw(Ljava/lang/String;Lcom/android/server/pm/PackageSetting;Ljava/lang/String;Lcom/android/server/pm/SharedUserSetting;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIIILandroid/os/UserHandle;ZZ)Lcom/android/server/pm/PackageSetting;
    ...
    invoke-virtual/range {v4 .. v17}, Lcom/android/server/pm/PackageSetting;->setUserState(IIZZZZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;ZII)V
...
.method readLPw(Lcom/android/server/pm/PackageManagerService;Ljava/util/List;IZ)Z
    ...
    const-string v5, "Create version info if not exist."
    ...
    .line 2832
    .restart local v49    # "ver":Lcom/android/server/pm/Settings$VersionInfo;
    if-nez v49, :cond_2
    ...
    const-string v4, "Create version info if not exist."
...
.method readPackageRestrictionsLPr(I)V
    ...
    const-string v41, "Reading from backup stopped packages file\n"
    ...
    const-string v41, "Need to read from backup stopped packages file"
    ...
    const-string v42, "Cleaning up stopped packages file "
    ...
    const-string v41, "No stopped packages file found\n"
    ...
    const-string v41, "No stopped packages file; assuming all started"
    ...
    invoke-virtual/range {v3 .. v16}, Lcom/android/server/pm/PackageSetting;->setUserState(IIZZZZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;ZII)V
    :try_end_2
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    const-string v41, "Error reading package manager stopped packages"
    ...
    const-string v41, "No start tag found in package restrictions file\n"
    ...
    const-string v41, "No start tag found in package manager stopped packages"
    ...
    const-string v42, "No package known for stopped package: "
    ...
    const-string v41, "enabledCaller"
    ...
    .line 1615
    .local v34, "stoppedStr":Ljava/lang/String;
    if-nez v34, :cond_e
    ...
    .line 1618
    .local v33, "restrictedStr":Ljava/lang/String;
    if-nez v33, :cond_f
    ...
    .line 1629
    .local v29, "notLaunchedStr":Ljava/lang/String;
    if-nez v34, :cond_12
    ...
    const-string v41, "blockUninstall"
    ...
    const-string v41, "domainVerificationStatus"
    ...
    .line 1638
    .local v40, "verifStateStr":Ljava/lang/String;
    if-nez v40, :cond_14

    const/16 v16, 0x0

    .line 1642
    .local v16, "verifState":I
    :goto_10
    const/4 v5, 0x0

    const-string v41, "app-link-generation"
    ...
    .line 1643
    .local v26, "linkGenStr":Ljava/lang/String;
    if-nez v26, :cond_15

    const/16 v17, 0x0

    .line 1644
    .local v17, "linkGeneration":I
    :goto_11
    move/from16 v0, v17
    ...
    .end local v16    # "verifState":I
    .end local v17    # "linkGeneration":I
    ...
    .end local v26    # "linkGenStr":Ljava/lang/String;
    .end local v29    # "notLaunchedStr":Ljava/lang/String;
    .end local v31    # "packageDepth":I
    .end local v33    # "restrictedStr":Ljava/lang/String;
    .end local v34    # "stoppedStr":Ljava/lang/String;
    .end local v40    # "verifStateStr":Ljava/lang/String;
    :cond_c
    invoke-static/range {v22 .. v22}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I
    ...
    .line 1615
    .restart local v7    # "installed":Z
    .restart local v34    # "stoppedStr":Ljava/lang/String;
    :cond_e
    ...
    .restart local v33    # "restrictedStr":Ljava/lang/String;
    :cond_f
    ...
    .line 1629
    .restart local v29    # "notLaunchedStr":Ljava/lang/String;
    :cond_12
    ...
    .restart local v40    # "verifStateStr":Ljava/lang/String;
    :cond_14
    ...
    .line 1643
    .restart local v16    # "verifState":I
    .restart local v26    # "linkGenStr":Ljava/lang/String;
    :cond_15
    invoke-static/range {v26 .. v26}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I
    ...
    .restart local v17    # "linkGeneration":I
    ...
    const-string v42, "Unknown element under <stopped-packages>: "
