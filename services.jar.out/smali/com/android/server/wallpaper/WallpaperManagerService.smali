...
.field static final SYSTEM_LOCKSCREENWALLPAPER:Ljava/lang/String; = "systemlockscreenwallpaper"
...
.method public getLockscreenWallpaper()Landroid/os/ParcelFileDescriptor;
    ...
    .line 960
    iget-object v5, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mScreenLock:[B
...
.method public saveSystemLockScreenWallpaper(Z)V
    .locals 10
    .param p1, "copyToSystem"    # Z
    ...
    :try_start_0
    iget v6, v5, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->userId:I
    ...
    const-string v8, " saveSystemLockScreenWallpaper,file="
    ...
    .end local v3    # "systemFile":Ljava/io/File;
    :goto_1
    invoke-static {v6, v3}, Landroid/os/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;)Z
    ...
    const-string v8, " saveSystemLockScreenWallpaper copyFile :"
    ...
    .restart local v3    # "systemFile":Ljava/io/File;
    :cond_1
    move-object v6, v3
...
.method public setLockscreenWallpaper(Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0, p1, v2}, Lcom/android/server/wallpaper/WallpaperManagerService;->updateLockScreenWallpaperBitmapLocked(Ljava/lang/String;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Landroid/os/ParcelFileDescriptor;
    ...
    const-string v6, " setLockscreenWallpaper(),pfd="
    ...
    iput-boolean v3, v2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->imageWallpaperPending:Z
    :try_end_1
...
.method updateLockScreenWallpaperBitmapLocked(Ljava/lang/String;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Landroid/os/ParcelFileDescriptor;
    .locals 9
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "wallpaper"    # Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    const-string v7, " setLockscreenWallpaper(),dir="
    ...
    const-string v6, " setLockscreenWallpaper(),file="
