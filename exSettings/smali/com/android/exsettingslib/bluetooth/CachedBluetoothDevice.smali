...
.method private connectAutoConnectableProfiles()V
    ...
    invoke-interface {v1, v2, v3}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->setPreferred(Landroid/bluetooth/BluetoothDevice;Z)V
...
.method private connectWithoutResettingTimer(Z)V
    ...
    invoke-interface {v2}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->isConnectable()Z
    ...
    invoke-interface {v2, v3}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->isPreferred(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    .line 235
    invoke-virtual {p0, v2}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->connectInt(Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;)V

    goto :goto_1

    .line 232
    :cond_3
    invoke-interface {v2}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->isAutoConnectable()Z
...
.method private updateProfiles()Z
    ...
    .line 491
    :cond_1
    iget-object v3, p0, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->mLocalAdapter:Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;

    invoke-virtual {v3}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;->getUuids()[Landroid/os/ParcelUuid;
...
.method public disconnect()V
    ...
    .line 178
    .local v2, "profile":Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;
    invoke-virtual {p0, v2}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->disconnect(Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;)V
...
.method public getConnectionSummary()I
    ...
    check-cast v4, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;

    .line 867
    .local v4, "profile":Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;
    invoke-virtual {p0, v4}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->getProfileConnectionState(Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;)I
    ...
    .line 879
    :pswitch_0
    invoke-interface {v4}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->isProfileReady()Z
    ...
    .line 880
    instance-of v6, v4, Lcom/android/exsettingslib/bluetooth/A2dpProfile;

    if-nez v6, :cond_1

    instance-of v6, v4, Lcom/android/exsettingslib/bluetooth/A2dpSinkProfile;
    ...
    .end local v4    # "profile":Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;
    :goto_1
    return v6

    .line 875
    .restart local v1    # "connectionStatus":I
    .restart local v4    # "profile":Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;
    :pswitch_2
    const/4 v5, 0x1
    ...
    .line 883
    :cond_2
    instance-of v6, v4, Lcom/android/exsettingslib/bluetooth/HeadsetProfile;
...
.method public isBusy()Z
    ...
    .line 471
    .local v1, "profile":Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;
    invoke-virtual {p0, v1}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->getProfileConnectionState(Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;)I
...
.method public startPairing()Z
    ...
    .line 299
    iget-object v1, p0, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->mLocalAdapter:Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;

    invoke-virtual {v1}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;->isDiscovering()Z
    ...
    invoke-virtual {v1}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;->cancelDiscovery()V
    ...
    .line 307
    :cond_1
    iput-boolean v0, p0, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->mConnectAfterPairing:Z
...
.method public unpair()V
    ...
    invoke-direct {p0, v5}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->describe(Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;)Ljava/lang/String;
