...
.method static synthetic access$000(Lcom/android/exsettings/users/EditUserInfoController;)Landroid/os/UserHandle;
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/users/EditUserInfoController;
...
.method static synthetic access$100(Lcom/android/exsettings/users/EditUserInfoController;)Landroid/os/UserManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/users/EditUserInfoController;
...
.method static synthetic access$200(Lcom/android/exsettings/users/EditUserInfoController;)Lcom/android/exsettings/users/EditUserPhotoController;
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/users/EditUserInfoController;
...
.method public createDialog(Landroid/app/Fragment;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ILcom/android/exsettings/users/EditUserInfoController$OnContentChangedCallback;Landroid/os/UserHandle;)Landroid/app/Dialog;
    ...
    invoke-static {v14, v2}, Lcom/android/exsettings/drawable/CircleFramedDrawable;->getInstance(Landroid/content/Context;Landroid/graphics/Bitmap;)Lcom/android/exsettings/drawable/CircleFramedDrawable;
    ...
    new-instance v7, Lcom/android/exsettings/users/EditUserInfoController$2;
    ...
    invoke-direct/range {v7 .. v13}, Lcom/android/exsettings/users/EditUserInfoController$2;-><init>(Lcom/android/exsettings/users/EditUserInfoController;Landroid/widget/EditText;Ljava/lang/CharSequence;Lcom/android/exsettings/users/EditUserInfoController$OnContentChangedCallback;Landroid/graphics/drawable/Drawable;Landroid/app/Fragment;)V
    ...
    new-instance v5, Lcom/android/exsettings/users/EditUserInfoController$1;

    move-object/from16 v0, p0

    invoke-direct {v5, v0}, Lcom/android/exsettings/users/EditUserInfoController$1;-><init>(Lcom/android/exsettings/users/EditUserInfoController;)V
    ...
    invoke-static {v14, v2, v0}, Lcom/android/exsettings/Utils;->getUserIcon(Landroid/content/Context;Landroid/os/UserManager;Landroid/content/pm/UserInfo;)Landroid/graphics/drawable/Drawable;
