...
.method public init(Lcom/android/exsettings/SettingsPreferenceFragment;)Landroid/preference/Preference;
    ...
    iget-object v7, p0, Lcom/android/exsettings/notification/SettingPref;->mKey:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/exsettings/notification/SettingPref;->isApplicable(Landroid/content/Context;)Z
    ...
    iput-object v6, p0, Lcom/android/exsettings/notification/SettingPref;->mTwoState:Landroid/preference/TwoStatePreference;

    .line 79
    :cond_1
    invoke-virtual {p0, v1}, Lcom/android/exsettings/notification/SettingPref;->update(Landroid/content/Context;)V

    .line 80
    iget-object v6, p0, Lcom/android/exsettings/notification/SettingPref;->mTwoState:Landroid/preference/TwoStatePreference;

    if-eqz v6, :cond_3

    .line 81
    new-instance v6, Lcom/android/exsettings/notification/SettingPref$1;

    invoke-direct {v6, p0, v1}, Lcom/android/exsettings/notification/SettingPref$1;-><init>(Lcom/android/exsettings/notification/SettingPref;Landroid/content/Context;)V
    ...
    .line 73
    :cond_2
    instance-of v6, v4, Lcom/android/exsettings/DropDownPreference;
    ...
    .line 74
    check-cast v6, Lcom/android/exsettings/DropDownPreference;

    iput-object v6, p0, Lcom/android/exsettings/notification/SettingPref;->mDropDown:Lcom/android/exsettings/DropDownPreference;

    .line 75
    iget-object v0, p0, Lcom/android/exsettings/notification/SettingPref;->mValues:[I
    ...
    invoke-virtual {p0, v7, v5}, Lcom/android/exsettings/notification/SettingPref;->getCaption(Landroid/content/res/Resources;I)Ljava/lang/String;
    ...
    new-instance v7, Lcom/android/exsettings/notification/SettingPref$2;

    invoke-direct {v7, p0, v1}, Lcom/android/exsettings/notification/SettingPref$2;-><init>(Lcom/android/exsettings/notification/SettingPref;Landroid/content/Context;)V

    invoke-virtual {v6, v7}, Lcom/android/exsettings/DropDownPreference;->setCallback(Lcom/android/exsettings/DropDownPreference$Callback;)V
...
.method public update(Landroid/content/Context;)V
    ...
    .prologue
    .line 115
    iget v1, p0, Lcom/android/exsettings/notification/SettingPref;->mType:I

    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v2

    iget-object v3, p0, Lcom/android/exsettings/notification/SettingPref;->mSetting:Ljava/lang/String;

    iget v4, p0, Lcom/android/exsettings/notification/SettingPref;->mDefault:I

    invoke-static {v1, v2, v3, v4}, Lcom/android/exsettings/notification/SettingPref;->getInt(ILandroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v0

    .line 116
    .local v0, "val":I
    iget-object v1, p0, Lcom/android/exsettings/notification/SettingPref;->mTwoState:Landroid/preference/TwoStatePreference;
