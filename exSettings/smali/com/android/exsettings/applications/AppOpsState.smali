...
.method static constructor <clinit>()V
    ...
    new-array v0, v0, [Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;

    const/4 v1, 0x0

    sget-object v2, Lcom/android/exsettings/applications/AppOpsState;->LOCATION_TEMPLATE:Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lcom/android/exsettings/applications/AppOpsState;->PERSONAL_TEMPLATE:Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    sget-object v2, Lcom/android/exsettings/applications/AppOpsState;->MESSAGING_TEMPLATE:Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;

    aput-object v2, v0, v1

    const/4 v1, 0x3

    sget-object v2, Lcom/android/exsettings/applications/AppOpsState;->MEDIA_TEMPLATE:Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;

    aput-object v2, v0, v1

    const/4 v1, 0x4

    sget-object v2, Lcom/android/exsettings/applications/AppOpsState;->DEVICE_TEMPLATE:Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;
...
.method private addOp(Ljava/util/List;Landroid/app/AppOpsManager$PackageOps;Lcom/android/exsettings/applications/AppOpsState$AppEntry;Landroid/app/AppOpsManager$OpEntry;ZI)V
    ...
    .line 448
    .restart local v2    # "last":Lcom/android/exsettings/applications/AppOpsState$AppOpEntry;
    :cond_0
    const/4 v3, 0x0
...
.method private getAppEntry(Landroid/content/Context;Ljava/util/HashMap;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Lcom/android/exsettings/applications/AppOpsState$AppEntry;
    .locals 5
    .param p1, "context"    # Landroid/content/Context;
...
.method public buildState(Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;ILjava/lang/String;)Ljava/util/List;
    ...
    .line 498
    .local v17, "appEntries":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/android/exsettings/applications/AppOpsState$AppEntry;>;"
    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    .line 500
    .local v4, "entries":Ljava/util/List;, "Ljava/util/List<Lcom/android/exsettings/applications/AppOpsState$AppOpEntry;>;"
    ...
    iget-object v8, v0, Lcom/android/exsettings/applications/AppOpsState$OpsTemplate;->ops:[I
    ...
    invoke-direct {v0, v1, v2, v3, v8}, Lcom/android/exsettings/applications/AppOpsState;->getAppEntry(Landroid/content/Context;Ljava/util/HashMap;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Lcom/android/exsettings/applications/AppOpsState$AppEntry;

    move-result-object v6

    .line 525
    .local v6, "appEntry":Lcom/android/exsettings/applications/AppOpsState$AppEntry;
    if-nez v6, :cond_4
    ...
    .end local v6    # "appEntry":Lcom/android/exsettings/applications/AppOpsState$AppEntry;
    ...
    .restart local v6    # "appEntry":Lcom/android/exsettings/applications/AppOpsState$AppEntry;
    :cond_4
    const/16 v23, 0x0
    ...
    invoke-direct/range {v3 .. v9}, Lcom/android/exsettings/applications/AppOpsState;->addOp(Ljava/util/List;Landroid/app/AppOpsManager$PackageOps;Lcom/android/exsettings/applications/AppOpsState$AppEntry;Landroid/app/AppOpsManager$OpEntry;ZI)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/exsettings/applications/AppOpsState$AppEntry;->hasOp(I)Z
