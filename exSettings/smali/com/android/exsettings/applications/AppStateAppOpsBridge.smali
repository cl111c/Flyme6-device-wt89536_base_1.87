...
.method private getEntries()Landroid/util/SparseArray;
    ...
    iget-object v2, v0, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->mPermissions:[Ljava/lang/String;
    ...
    .line 164
    .local v4, "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;>;>;"
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->mProfiles:Ljava/util/List;
    ...
    .line 166
    .local v5, "entriesForProfile":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;>;"
    ...
    invoke-direct {v0, v11}, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->shouldIgnorePackage(Ljava/lang/String;)Z
    ...
    .line 172
    new-instance v10, Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;

    invoke-direct {v10, v11, v15}, Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;-><init>(Ljava/lang/String;Landroid/os/UserHandle;)V

    .line 173
    .local v10, "newEntry":Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;
    ...
    .line 179
    .end local v2    # "arr$":[Ljava/lang/String;
    .end local v4    # "entries":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;>;>;"
    .end local v5    # "entriesForProfile":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;>;"
    .end local v7    # "i$":Ljava/util/Iterator;
    .end local v8    # "isAvailable":Z
    .end local v9    # "len$":I
    .end local v10    # "newEntry":Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;
...
.method private loadAppOpsStates(Landroid/util/SparseArray;)V
    ...
    iget-object v9, p0, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->mAppOpsOpCodes:[I
    ...
    iget-object v10, p0, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->mPermissions:[Ljava/lang/String;
...
.method private loadPermissionsStates(Landroid/util/SparseArray;)V
    ...
    .line 193
    :try_start_0
    iget-object v11, p0, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->mProfiles:Ljava/util/List;
    ...
    .line 200
    iget-object v11, p0, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->mIPackageManager:Landroid/content/pm/IPackageManager;
    ...
    .line 206
    .local v7, "pe":Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;
    if-eqz v7, :cond_1

    .line 207
    iput-object v4, v7, Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;->packageInfo:Landroid/content/pm/PackageInfo;

    .line 208
    const/4 v11, 0x1

    iput-boolean v11, v7, Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;->staticPermissionGranted:Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v7    # "pe":Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;
    :cond_2
    move v5, v10
...
.method public getNumPackagesAllowedByAppOps()I
    ...
    check-cast v3, Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;

    .line 291
    .local v3, "permState":Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;
    invoke-virtual {v3}, Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;->isPermissible()Z
...
.method public getNumPackagesDeclaredPermission()I
    ...
    .line 268
    :cond_1
    iget-object v3, p0, Lcom/android/exsettings/applications/AppStateAppOpsBridge;->mUserManager:Landroid/os/UserManager;
...
.method public getPermissionInfo(Ljava/lang/String;I)Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;
    ...
    iget-object v8, v4, Lcom/android/exsettings/applications/AppStateAppOpsBridge$PermissionState;->userHandle:Landroid/os/UserHandle;
