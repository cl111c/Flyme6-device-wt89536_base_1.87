...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/exsettings/DreamSettings$PackageReceiver;-><init>(Lcom/android/exsettings/DreamSettings;Lcom/android/exsettings/DreamSettings$1;)V
...
.method static synthetic access$100(Lcom/android/exsettings/DreamSettings;)Lcom/android/exsettings/DreamBackend;
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/DreamSettings;
...
.method static synthetic access$400(Lcom/android/exsettings/DreamSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/exsettings/DreamSettings;
...
.method private createWhenToDreamDialog()Landroid/app/Dialog;
    ...
    iget-object v4, p0, Lcom/android/exsettings/DreamSettings;->mBackend:Lcom/android/exsettings/DreamBackend;

    invoke-virtual {v4}, Lcom/android/exsettings/DreamBackend;->isActivatedOnDock()Z
    ...
    invoke-virtual {v4}, Lcom/android/exsettings/DreamBackend;->isActivatedOnSleep()Z
...
.method private refreshFromBackend()V
    ...
    invoke-static {v6, v7}, Lcom/android/exsettings/DreamSettings;->logd(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 267
    const/4 v6, 0x1

    iput-boolean v6, p0, Lcom/android/exsettings/DreamSettings;->mRefreshing:Z

    .line 268
    iget-object v6, p0, Lcom/android/exsettings/DreamSettings;->mBackend:Lcom/android/exsettings/DreamBackend;

    invoke-virtual {v6}, Lcom/android/exsettings/DreamBackend;->isEnabled()Z

    move-result v2

    .line 269
    .local v2, "dreamsEnabled":Z
    iget-object v6, p0, Lcom/android/exsettings/DreamSettings;->mSwitchBar:Lcom/android/exsettings/widget/SwitchBar;

    invoke-virtual {v6}, Lcom/android/exsettings/widget/SwitchBar;->isChecked()Z
    ...
    invoke-virtual {v6, v2}, Lcom/android/exsettings/widget/SwitchBar;->setChecked(Z)V

    .line 272
    :cond_0
    iget-object v6, p0, Lcom/android/exsettings/DreamSettings;->mAdapter:Lcom/android/exsettings/DreamSettings$DreamInfoAdapter;

    invoke-virtual {v6}, Lcom/android/exsettings/DreamSettings$DreamInfoAdapter;->clear()V
    ...
    invoke-virtual {v6}, Lcom/android/exsettings/DreamBackend;->getDreamInfos()Ljava/util/List;

    move-result-object v1

    .line 275
    .local v1, "dreamInfos":Ljava/util/List;, "Ljava/util/List<Lcom/android/exsettings/DreamBackend$DreamInfo;>;"
    iget-object v6, p0, Lcom/android/exsettings/DreamSettings;->mAdapter:Lcom/android/exsettings/DreamSettings$DreamInfoAdapter;

    invoke-virtual {v6, v1}, Lcom/android/exsettings/DreamSettings$DreamInfoAdapter;->addAll(Ljava/util/Collection;)V

    .line 277
    .end local v1    # "dreamInfos":Ljava/util/List;, "Ljava/util/List<Lcom/android/exsettings/DreamBackend$DreamInfo;>;"
    :cond_1
    iget-object v6, p0, Lcom/android/exsettings/DreamSettings;->mMenuItemsWhenEnabled:[Landroid/view/MenuItem;

    if-eqz v6, :cond_2

    .line 278
    iget-object v0, p0, Lcom/android/exsettings/DreamSettings;->mMenuItemsWhenEnabled:[Landroid/view/MenuItem;
    ...
    :cond_2
    iput-boolean v8, p0, Lcom/android/exsettings/DreamSettings;->mRefreshing:Z
