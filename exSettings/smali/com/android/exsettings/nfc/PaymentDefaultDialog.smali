...
.method private buildDialog(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    .line 83
    .local v6, "requestedPaymentApp":Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;
    const/4 v1, 0x0

    .line 85
    .local v1, "defaultPaymentApp":Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;
    iget-object v11, p0, Lcom/android/exsettings/nfc/PaymentDefaultDialog;->mBackend:Lcom/android/exsettings/nfc/PaymentBackend;

    invoke-virtual {v11}, Lcom/android/exsettings/nfc/PaymentBackend;->getPaymentAppInfos()Ljava/util/List;
    ...
    check-cast v7, Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;

    .line 87
    .local v7, "service":Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;
    iget-object v11, v7, Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;->componentName:Landroid/content/ComponentName;
    ...
    .line 90
    :cond_4
    iget-boolean v11, v7, Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;->isDefault:Z
    ...
    .line 95
    .end local v7    # "service":Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;
    :cond_5
    if-nez v6, :cond_6
    ...
    invoke-virtual {v11}, Lcom/android/exsettings/nfc/PaymentBackend;->getDefaultPaymentApp()Landroid/content/ComponentName;
    ...
    .line 109
    iget-object v5, p0, Lcom/android/exsettings/nfc/PaymentDefaultDialog;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;

    .line 110
    .local v5, "p":Lcom/android/internal/app/AlertController$AlertParams;
    const v11, 0x7f0c0972

    invoke-virtual {p0, v11}, Lcom/android/exsettings/nfc/PaymentDefaultDialog;->getString(I)Ljava/lang/String;
    ...
    iget-object v12, v6, Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;->label:Ljava/lang/CharSequence;

    invoke-interface {v12}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v12

    invoke-direct {p0, v12}, Lcom/android/exsettings/nfc/PaymentDefaultDialog;->sanitizePaymentAppCaption(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v1, Lcom/android/exsettings/nfc/PaymentBackend$PaymentAppInfo;->label:Ljava/lang/CharSequence;

    invoke-interface {v9}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v9

    invoke-direct {p0, v9}, Lcom/android/exsettings/nfc/PaymentDefaultDialog;->sanitizePaymentAppCaption(Ljava/lang/String;)Ljava/lang/String;
