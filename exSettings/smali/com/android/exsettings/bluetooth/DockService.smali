...
.method public constructor <init>()V
    ...
    .line 613
    new-instance v0, Lcom/android/exsettings/bluetooth/DockService$5;

    invoke-direct {v0, p0}, Lcom/android/exsettings/bluetooth/DockService$5;-><init>(Lcom/android/exsettings/bluetooth/DockService;)V
...
.method static synthetic access$100(Lcom/android/exsettings/bluetooth/DockService;Landroid/os/Message;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
...
.method static synthetic access$200(Lcom/android/exsettings/bluetooth/DockService;Landroid/bluetooth/BluetoothDevice;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
...
.method static synthetic access$300(Lcom/android/exsettings/bluetooth/DockService;)[Z
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
...
.method static synthetic access$400(Lcom/android/exsettings/bluetooth/DockService;)Landroid/bluetooth/BluetoothDevice;
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
...
.method static synthetic access$500(Lcom/android/exsettings/bluetooth/DockService;)Landroid/bluetooth/BluetoothDevice;
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
...
.method static synthetic access$600(Lcom/android/exsettings/bluetooth/DockService;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
...
.method static synthetic access$700(Lcom/android/exsettings/bluetooth/DockService;Landroid/bluetooth/BluetoothDevice;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
    .param p1, "x1"    # Landroid/bluetooth/BluetoothDevice;
    .param p2, "x2"    # I
...
.method static synthetic access$800(Lcom/android/exsettings/bluetooth/DockService;)Landroid/widget/CheckBox;
    .locals 1
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/DockService;
...
.method private declared-synchronized applyBtSettings(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    :try_start_0
    iget-object v10, p0, Lcom/android/exsettings/bluetooth/DockService;->mProfiles:[Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;

    if-eqz v10, :cond_0

    iget-object v10, p0, Lcom/android/exsettings/bluetooth/DockService;->mCheckedItems:[Z
    ...
    .line 834
    iget-object v10, p0, Lcom/android/exsettings/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;

    if-eqz v10, :cond_2

    iget-object v10, p0, Lcom/android/exsettings/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;

    iget-object v11, p0, Lcom/android/exsettings/bluetooth/DockService;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    :try_start_2
    iput-object v10, p0, Lcom/android/exsettings/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    .line 858
    .local v8, "profile":Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;
    iget-object v10, p0, Lcom/android/exsettings/bluetooth/DockService;->mCheckedItems:[Z
    ...
    invoke-interface {v8, p1, v10}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->setPreferred(Landroid/bluetooth/BluetoothDevice;Z)V
    ...
    .line 863
    invoke-virtual {v2}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->getDevice()Landroid/bluetooth/BluetoothDevice;

    move-result-object v10

    invoke-interface {v8, v10}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->getConnectionStatus(Landroid/bluetooth/BluetoothDevice;)I
    ...
    invoke-virtual {v2, v10}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->disconnect(Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;)V

    goto :goto_3

    .line 877
    .end local v8    # "profile":Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;
    ...
    invoke-virtual {v2, v10}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDevice;->connect(Z)V
    :try_end_2
...
.method private declared-synchronized connectIfEnabled(Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-interface {v2, p1}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;->getPreferred(Landroid/bluetooth/BluetoothDevice;)I
...
.method private createDialog(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    invoke-virtual {p0, v4, v6}, Lcom/android/exsettings/bluetooth/DockService;->startForeground(ILandroid/app/Notification;)V
...
.method private handleBluetoothStateOn(I)V
    ...
    .line 739
    :cond_0
    iput-object v8, p0, Lcom/android/exsettings/bluetooth/DockService;->mPendingDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    .line 769
    iput v6, p0, Lcom/android/exsettings/bluetooth/DockService;->mPendingTurnOnStartId:I
    ...
    invoke-virtual {p0, v8, v4}, Lcom/android/exsettings/bluetooth/DockService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private declared-synchronized handleUnexpectedDisconnect(Landroid/bluetooth/BluetoothDevice;Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfile;I)V
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/exsettings/bluetooth/DockService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private msgTypeDisableBluetooth(I)Z
    ...
    invoke-virtual {v2}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;->disable()Z
...
.method private msgTypeDocked(Landroid/bluetooth/BluetoothDevice;II)Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/exsettings/bluetooth/DockService$ServiceHandler;->removeMessages(I)V
    ...
    .line 386
    iget-object v3, p0, Lcom/android/exsettings/bluetooth/DockService;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-direct {p0, v3}, Lcom/android/exsettings/bluetooth/DockService;->handleUndocked(Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-virtual {v3, p0}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfileManager;->addServiceListener(Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfileManager$ServiceListener;)V

    .line 398
    iget-object v3, p0, Lcom/android/exsettings/bluetooth/DockService;->mProfileManager:Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfileManager;

    invoke-virtual {v3}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothProfileManager;->isManagerReady()Z
    ...
    new-instance v3, Lcom/android/exsettings/bluetooth/DockService$1;

    invoke-direct {v3, p0, v0, p2, p3}, Lcom/android/exsettings/bluetooth/DockService$1;-><init>(Lcom/android/exsettings/bluetooth/DockService;Landroid/bluetooth/BluetoothDevice;II)V

    iput-object v3, p0, Lcom/android/exsettings/bluetooth/DockService;->mRunnable:Ljava/lang/Runnable;
    ...
    invoke-direct {p0, v3, p2, p3}, Lcom/android/exsettings/bluetooth/DockService;->handleDocked(Landroid/bluetooth/BluetoothDevice;II)V
...
.method private msgTypeUndockedPermanent(Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    invoke-virtual {v3, v4, v2, p2, v5}, Lcom/android/exsettings/bluetooth/DockService$ServiceHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method declared-synchronized hasOtherConnectedDevices(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/exsettings/bluetooth/DockService;->mDeviceManager:Lcom/android/exsettingslib/bluetooth/CachedBluetoothDeviceManager;

    invoke-virtual {v6}, Lcom/android/exsettingslib/bluetooth/CachedBluetoothDeviceManager;->getCachedDevicesCopy()Ljava/util/Collection;
    ...
    iget-object v6, p0, Lcom/android/exsettings/bluetooth/DockService;->mLocalAdapter:Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;

    invoke-virtual {v6}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;->getBondedDevices()Ljava/util/Set;
...
.method public onCreate()V
    ...
    invoke-direct {v2, p0, v3, v4}, Lcom/android/exsettings/bluetooth/DockService$ServiceHandler;-><init>(Lcom/android/exsettings/bluetooth/DockService;Landroid/os/Looper;Lcom/android/exsettings/bluetooth/DockService$1;)V
