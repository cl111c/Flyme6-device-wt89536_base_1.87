...
# direct methods
.method static synthetic access$000(Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;
...
.method private getDiscoverableTimeout()I
    ...
    .line 210
    iget v0, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mTimeoutSecs:I
...
.method public pause()V
    ...
    .prologue
    .line 119
    iget-object v0, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mLocalAdapter:Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;
    ...
    .line 123
    :cond_0
    iget-object v0, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mUiHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mUpdateCountdownSummaryRunnable:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 124
    iget-object v0, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mContext:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method public resume(Landroid/content/Context;)V
    ...
    .prologue
    .line 104
    iget-object v1, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mLocalAdapter:Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;
    ...
    .line 108
    :cond_0
    iget-object v1, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mContext:Landroid/content/Context;

    if-eq v1, p1, :cond_1

    .line 109
    iput-object p1, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v1}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;->getScanMode()I

    move-result v1

    invoke-virtual {p0, v1}, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->handleModeChanged(I)V
...
.method setNumberOfPairedDevices(I)V
    ...
    .prologue
    .line 251
    iput p1, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mNumberOfPairedDevices:I

    .line 252
    iget-object v0, p0, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->mLocalAdapter:Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;

    invoke-virtual {v0}, Lcom/android/exsettingslib/bluetooth/LocalBluetoothAdapter;->getScanMode()I

    move-result v0

    invoke-virtual {p0, v0}, Lcom/android/exsettings/bluetooth/BluetoothDiscoverableEnabler;->handleModeChanged(I)V
