...
.method private checkDefaultLocale()V
    ...
    iput-object v3, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mSampleText:Ljava/lang/String;
...
.method private evaluateDefaultLocale()Z
    ...
    .line 294
    iget-object v8, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mCurrentDefaultLocale:Ljava/util/Locale;

    if-eqz v8, :cond_0

    iget-object v8, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mAvailableStrLocals:Ljava/util/List;
    ...
    iget-object v9, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mCurrentDefaultLocale:Ljava/util/Locale;
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mTts:Landroid/speech/tts/TextToSpeech;
    ...
    .line 328
    invoke-direct {p0, v7}, Lcom/android/exsettings/tts/TextToSpeechSettings;->updateWidgetState(Z)V
    ...
    invoke-direct {p0, v7}, Lcom/android/exsettings/tts/TextToSpeechSettings;->updateEngineStatus(I)V

    .line 336
    :goto_1
    invoke-direct {p0, v6}, Lcom/android/exsettings/tts/TextToSpeechSettings;->updateWidgetState(Z)V
...
.method private getDefaultSampleString()Ljava/lang/String;
    ...
    .prologue
    .line 382
    iget-object v4, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mTts:Landroid/speech/tts/TextToSpeech;
    ...
    invoke-virtual {p0, v4}, Lcom/android/exsettings/tts/TextToSpeechSettings;->getString(I)Ljava/lang/String;
...
.method private initSettings()V
    ...
    .line 243
    .restart local v0    # "activity":Lcom/android/exsettings/SettingsActivity;
    ...
    new-instance v3, Lcom/android/exsettings/tts/TtsEnginePreference;

    invoke-virtual {p0}, Lcom/android/exsettings/tts/TextToSpeechSettings;->getActivity()Landroid/app/Activity;

    move-result-object v7

    invoke-direct {v3, v7, v2, p0, v0}, Lcom/android/exsettings/tts/TtsEnginePreference;-><init>(Landroid/content/Context;Landroid/speech/tts/TextToSpeech$EngineInfo;Lcom/android/exsettings/tts/TtsEnginePreference$RadioButtonGroupState;Lcom/android/exsettings/SettingsActivity;)V

    .line 249
    .local v3, "enginePref":Lcom/android/exsettings/tts/TtsEnginePreference;
    iget-object v7, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mEnginePreferenceCategory:Landroid/preference/PreferenceCategory;
    ...
    .end local v3    # "enginePref":Lcom/android/exsettings/tts/TtsEnginePreference;
...
.method public onUpdateEngine(I)V
    ...
    iput-object v0, p0, Lcom/android/exsettings/tts/TextToSpeechSettings;->mPreviousEngine:Ljava/lang/String;
