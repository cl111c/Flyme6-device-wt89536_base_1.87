...
# WfdService com.qualcomm.location CNEService qcrilmsgtunnel TelephonyExtVodafonePack QtiTelephonyService FingerprintServiceExtension PhoneKeeper SmartFingerprint dpmserviceapp CellBroadcastReceiver BMCT BMCTProvider CarrierCacheService CarrierLoadService ConferenceDialer DataStorageCleanerService DeviceInfo ExtSettings fingerprintservice-release-signed MdtpService ModemTestMode PhoneFeatures PowerOffHandlerApp PrimaryCardController
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothExt BluetoothMidiService HTMLViewer KeyChain NfcNci PicoTts PrintSpooler Stk UserDictionaryProvider BackupRestoreConfirmation DefaultContainerService ExternalStorageProvider FusedLocation InputDevices ProxyHandler SharedStorageBackup Shell AntHalService BatterySaver datastatusnotification NFC telresources TimeService WfdService com.qualcomm.location CNEService qcrilmsgtunnel QtiTelephonyService FingerprintServiceExtension SmartFingerprint FactoryTest btmultisim CarrierCacheService CarrierLoadService fastdormancy MdtpService PhoneFeatures PrimaryCardController SmartWakeSystem SmartAlertLight radioconfig FM2 ims shutdownlistener
...
override_property += \
    ro.flyme.romer=orange \
    ro.product.model_romer=M836_orange \
    ro.product.device=wt89536
