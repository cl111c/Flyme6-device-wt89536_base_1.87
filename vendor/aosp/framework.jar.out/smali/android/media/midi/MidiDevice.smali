...
.method public connectPorts(Landroid/media/midi/MidiInputPort;I)Landroid/media/midi/MidiDevice$MidiConnection;
    ...
    iget-object v5, p0, Landroid/media/midi/MidiDevice;->mDeviceInfo:Landroid/media/midi/MidiDeviceInfo;

    invoke-virtual {v5}, Landroid/media/midi/MidiDeviceInfo;->getOutputPortCount()I
    ...
    .line 185
    :cond_1
    iget-boolean v5, p0, Landroid/media/midi/MidiDevice;->mIsDeviceClosed:Z
    ...
    invoke-interface {v5, v3, v2, p2}, Landroid/media/midi/IMidiDeviceServer;->connectPorts(Landroid/os/IBinder;Landroid/os/ParcelFileDescriptor;I)I
    ...
    .line 205
    :cond_4
    new-instance v5, Landroid/media/midi/MidiDevice$MidiConnection;

    invoke-direct {v5, p0, v3, p1}, Landroid/media/midi/MidiDevice$MidiConnection;-><init>(Landroid/media/midi/MidiDevice;Landroid/os/IBinder;Landroid/media/midi/MidiInputPort;)V
    :try_end_0
    ...
    const-string v5, "MidiDevice"

    const-string v6, "RemoteException in connectPorts"
