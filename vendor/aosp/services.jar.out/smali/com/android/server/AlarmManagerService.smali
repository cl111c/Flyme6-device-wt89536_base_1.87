...
.field private final mHeartbeatReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mHeartbeatReceiver:Landroid/content/BroadcastReceiver;

    .line 2854
    new-instance v0, Lcom/android/server/AlarmManagerService$5;

    invoke-direct {v0, p0}, Lcom/android/server/AlarmManagerService$5;-><init>(Lcom/android/server/AlarmManagerService;)V

    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mBootCompletedReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$400(Lcom/android/server/AlarmManagerService;)Lcom/android/server/AlarmAlignHelper;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/AlarmManagerService;
...
.method public static scheduleHeartbeatRequest(Landroid/content/Context;)V
    .locals 5
    .param p0, "context"    # Landroid/content/Context;
    ...
    const-string v4, "HeartbeatFixerUtils, scheduleHeartbeatRequest"
    ...
    invoke-static {p0, v2}, Lcom/android/server/AlarmManagerService;->setNextHeartbeatRequest(Landroid/content/Context;I)V
...
.method private setImplLocked(IJJJJJLandroid/app/PendingIntent;IZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
    ...
    iget-object v5, v0, Lcom/android/server/AlarmManagerService;->mAlignHelper:Lcom/android/server/AlarmAlignHelper;

    move-object/from16 v0, p12

    invoke-virtual {v5, v0}, Lcom/android/server/AlarmAlignHelper;->matchBeatListPackage(Landroid/app/PendingIntent;)Landroid/app/PowerGuruAlarmInfo;

    move-result-object v21

    .line 1068
    .local v21, "guruAlarm":Landroid/app/PowerGuruAlarmInfo;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v5, v0}, Lcom/android/server/AlarmAlignHelper;->isUnavailableGMS(Landroid/app/PowerGuruAlarmInfo;)Z
    ...
    invoke-virtual {v5}, Lcom/android/server/AlarmAlignHelper;->getEnable()Z
    ...
    invoke-virtual {v5, v0, v1}, Lcom/android/server/AlarmAlignHelper;->checkAlignEnable(ILandroid/app/PowerGuruAlarmInfo;)Z
    ...
    iget-object v7, v0, Landroid/app/PowerGuruAlarmInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, " isFromGMS = "
    ...
    iget-boolean v5, v0, Landroid/app/PowerGuruAlarmInfo;->isFromGMS:Z
    ...
    invoke-virtual {v5, v0, v1, v2, v6}, Lcom/android/server/AlarmAlignHelper;->adjustTriggerTime(JIZ)J
    ...
    iput-wide v6, v4, Lcom/android/server/AlarmManagerService$Alarm;->maxWhenElapsed:J
    ...
    iput-boolean v5, v4, Lcom/android/server/AlarmManagerService$Alarm;->tiggerTimeAdjusted:Z
...
.method private static setNextHeartbeatRequest(Landroid/content/Context;I)V
    .locals 13
    .param p0, "context"    # Landroid/content/Context;
    ...
    .line 2877
    .local v0, "adjustedStr":Ljava/lang/CharSequence;
    const-string v5, "AlarmManager"
    ...
    const-string v9, "setNextHeartbeatRequest at: "
    ...
    const-string v5, "com.android.HeartBeatForGCM"

    invoke-direct {v3, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 2879
    .local v3, "mHeatBeatIntent":Landroid/content/Intent;
    sget-object v5, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    invoke-static {p0, v12, v3, v12, v5}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;

    move-result-object v2

    .line 2880
    .local v2, "broadcastPendingIntent":Landroid/app/PendingIntent;
    const/4 v4, 0x2

    .line 2881
    .local v4, "rtcWakeup":I
    invoke-virtual {v1, v4, v6, v7, v2}, Landroid/app/AlarmManager;->setExact(IJLandroid/app/PendingIntent;)V
...
.method public onStart()V
    ...
    .line 854
    new-instance v0, Lcom/android/server/AlarmAlignHelper;

    invoke-virtual {p0}, Lcom/android/server/AlarmManagerService;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/android/server/AlarmAlignHelper;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mAlignHelper:Lcom/android/server/AlarmAlignHelper;
    ...
    invoke-static {v0, v4, v1, v4, v2}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;
    ...
    invoke-static {v0, v4, v6, v1, v2}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;
    ...
    iget-object v1, p0, Lcom/android/server/AlarmManagerService;->mBootCompletedReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 896
    .local v7, "mHeartBeatFilter":Landroid/content/IntentFilter;
    const-string v0, "com.android.HeartBeatForGCM"
    ...
    iget-object v1, p0, Lcom/android/server/AlarmManagerService;->mHeartbeatReceiver:Landroid/content/BroadcastReceiver;
    ...
    .end local v7    # "mHeartBeatFilter":Landroid/content/IntentFilter;
    :cond_0
...
.method setImpl(IJJJLandroid/app/PendingIntent;ILandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
    ...
    iget-object v8, v0, Lcom/android/server/AlarmManagerService;->mAlignHelper:Lcom/android/server/AlarmAlignHelper;
    ...
    invoke-virtual/range {v8 .. v20}, Lcom/android/server/AlarmAlignHelper;->notifyPowerGuru(IJJJJJLandroid/app/PendingIntent;)Z
