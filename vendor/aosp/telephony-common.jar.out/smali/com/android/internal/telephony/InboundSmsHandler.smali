...
.field private static final BLOCK_RECORD_CONTENT:Ljava/lang/String; = "content"

.field private static final BLOCK_RECORD_NUMBER:Ljava/lang/String; = "number"
...
.field private static final MMS_BLOCK_RECORD_INTENT:Ljava/lang/String; = "com.android.firewall.ADD_MMS_BLOCK_RECORD"
...
.field private static final SMS_BLOCK_RECORD_INTENT:Ljava/lang/String; = "com.android.firewall.ADD_SMS_BLOCK_RECORD"
...
.method static constructor <clinit>()V
    ...
    .line 213
    const-string v0, "content://com.android.firewall"
...
.method private isBlockMessage(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 5
    ...
    invoke-static {v4}, Lcom/cmdc/secure/CmFireWallManager;->get(Landroid/content/Context;)Lcom/cmdc/secure/CmFireWallManager;

    move-result-object v1

    .line 1599
    .local v1, "localCmFireWallManager":Lcom/cmdc/secure/CmFireWallManager;
    :try_start_0
    invoke-virtual {v1, p1, p2}, Lcom/cmdc/secure/CmFireWallManager;->getBlockedTypeByDNH_SMS(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
...
.method private isBlockedByFirewall(Ljava/lang/String;)Z
    .locals 6
...
.method private isPhoneAntiTheftSms(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 3
    .param p1, "phoneNo"    # Ljava/lang/String;
    .param p2, "smsContent"    # Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/cmdc/secure/CmAntiTheftManager;->get(Landroid/content/Context;)Lcom/cmdc/secure/CmAntiTheftManager;

    move-result-object v0

    .line 1612
    .local v0, "localCmAntiTheftManager":Lcom/cmdc/secure/CmAntiTheftManager;
    :try_start_0
    invoke-virtual {v0, p1, p2}, Lcom/cmdc/secure/CmAntiTheftManager;->getTypeAntiTheft(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private isSmsBlockedByFirewall(Landroid/content/Intent;)Z
    .locals 5
    .param p1, "intent"    # Landroid/content/Intent;
    ...
    .line 1502
    :cond_0
    const-string v3, "Failed to parse SMS pdu"
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/InboundSmsHandler;->isBlockedByFirewall(Ljava/lang/String;)Z
...
.method protected dispatchIntent(Landroid/content/Intent;Ljava/lang/String;ILandroid/os/Bundle;Landroid/content/BroadcastReceiver;Landroid/os/UserHandle;)V
    ...
    .prologue
    .line 932
    invoke-virtual/range {p0 .. p5}, Lcom/android/internal/telephony/InboundSmsHandler;->dispatchIntentByBlock(Landroid/content/Intent;Ljava/lang/String;ILandroid/os/Bundle;Landroid/content/BroadcastReceiver;)Z
...
.method public dispatchIntentByBlock(Landroid/content/Intent;Ljava/lang/String;ILandroid/os/Bundle;Landroid/content/BroadcastReceiver;)Z
    .locals 27
    .param p1, "intent"    # Landroid/content/Intent;
    .param p2, "permission"    # Ljava/lang/String;
    .param p3, "appOp"    # I
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/telephony/InboundSmsHandler;->isPhoneAntiTheftSms(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v3, "android.intent.action.ANTI_THEFT_SMS_RECEIVED_EMPTY"

    invoke-direct {v4, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1539
    .local v4, "antitheftintent":Landroid/content/Intent;
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/internal/telephony/InboundSmsHandler;->mContext:Landroid/content/Context;

    const-string v5, "android.permission.RECEIVE_ANTI_THEFT_SMS"
    ...
    .line 1586
    .end local v4    # "antitheftintent":Landroid/content/Intent;
    .end local v22    # "localSmsMessage":Landroid/telephony/SmsMessage;
    .end local v25    # "phoneNum":Ljava/lang/String;
    .end local v26    # "smsContent":Ljava/lang/String;
    :goto_0
    return v3

    .line 1543
    .restart local v22    # "localSmsMessage":Landroid/telephony/SmsMessage;
    .restart local v25    # "phoneNum":Ljava/lang/String;
    .restart local v26    # "smsContent":Ljava/lang/String;
    :cond_0
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/telephony/InboundSmsHandler;->isBlockMessage(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1546
    const-string v3, "android.intent.action.BLACKLIST_SMS_RECEIVED"
    ...
    const-string v5, "add SUBID for newIntent  "
    ...
    const-string v7, "android.permission.RECEIVE_BLACKLIST_SMS"
    ...
    invoke-virtual/range {v5 .. v13}, Landroid/content/Context;->sendOrderedBroadcast(Landroid/content/Intent;Ljava/lang/String;ILandroid/content/BroadcastReceiver;Landroid/os/Handler;ILjava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v3}, Lcom/android/internal/telephony/InboundSmsHandler;->shouldParseContentDisposition(I)Z
    ...
    invoke-direct {v0, v1, v3}, Lcom/google/android/mms/pdu/PduParser;-><init>([BZ)V

    .line 1557
    .local v21, "localPduParser":Lcom/google/android/mms/pdu/PduParser;
    invoke-virtual/range {v21 .. v21}, Lcom/google/android/mms/pdu/PduParser;->parse()Lcom/google/android/mms/pdu/GenericPdu;

    move-result-object v19

    .line 1558
    .local v19, "localGenericPdu1":Lcom/google/android/mms/pdu/GenericPdu;
    if-eqz v19, :cond_2

    const/16 v3, 0x82

    invoke-virtual/range {v19 .. v19}, Lcom/google/android/mms/pdu/GenericPdu;->getMessageType()I
    ...
    .line 1564
    .local v20, "localNotificationInd":Lcom/google/android/mms/pdu/NotificationInd;
    ...
    .line 1569
    .local v24, "phoneMmsNum":Ljava/lang/String;
    invoke-virtual/range {v20 .. v20}, Lcom/google/android/mms/pdu/NotificationInd;->getContentLocation()[B

    move-result-object v17

    .line 1570
    .local v17, "arrayOfByte2":[B
    ...
    .line 1572
    .local v23, "mmsContent":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v9, "android.permission.RECEIVE_BLACKLIST_SMS"
    ...
    .line 1578
    const-string v3, "BlackListReceiver -- Start "

    const-string v5, "android.intent.action.BLACKLIST_MMS_RECEIVED"
    ...
    .line 1582
    .end local v8    # "blockMmsIntent":Landroid/content/Intent;
    .end local v17    # "arrayOfByte2":[B
    .end local v19    # "localGenericPdu1":Lcom/google/android/mms/pdu/GenericPdu;
    .end local v20    # "localNotificationInd":Lcom/google/android/mms/pdu/NotificationInd;
    .end local v21    # "localPduParser":Lcom/google/android/mms/pdu/PduParser;
    .end local v23    # "mmsContent":Ljava/lang/String;
    .end local v24    # "phoneMmsNum":Ljava/lang/String;
    :catch_0
    move-exception v18

    .line 1583
    .local v18, "localException":Ljava/lang/Exception;
    ...
    .line 1586
    .end local v16    # "arrayOfByte1":[B
    .end local v18    # "localException":Ljava/lang/Exception;
    :cond_6
    const/4 v3, 0x0
...
.method public isMmsBlockedByFirewall(Ljava/lang/String;)Z
    .locals 1
    .param p1, "address"    # Ljava/lang/String;

    .prologue
    .line 1496
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/InboundSmsHandler;->isBlockedByFirewall(Ljava/lang/String;)Z
...
.method processMessagePart(Lcom/android/internal/telephony/InboundSmsTracker;)Z
    ...
    .line 826
    .local v10, "resultReceiver":Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;
    const/16 v2, 0xb84
    ...
    .line 773
    .end local v10    # "resultReceiver":Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;
    ...
    .restart local v23    # "cursorCount":I
    ...
    .line 843
    .end local v22    # "cursor":Landroid/database/Cursor;
    .restart local v10    # "resultReceiver":Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;
    .restart local v13    # "pdus":[[B
    ...
    invoke-virtual {v2, v3, v10, v0, v1}, Lcom/android/internal/telephony/WapPushOverSms;->dispatchWapPdu([BLandroid/content/BroadcastReceiver;Lcom/android/internal/telephony/InboundSmsHandler;Ljava/lang/String;)I
    ...
    .line 856
    .local v8, "blockItent":Landroid/content/Intent;
    ...
    invoke-direct {v0, v8}, Lcom/android/internal/telephony/InboundSmsHandler;->isSmsBlockedByFirewall(Landroid/content/Intent;)Z
    ...
    invoke-virtual/range {v7 .. v12}, Lcom/android/internal/telephony/InboundSmsHandler;->sendBlockRecordBroadcast(Landroid/content/Intent;ZLandroid/content/BroadcastReceiver;Ljava/lang/String;I)V
    ...
    .line 865
    .local v20, "carrierPackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 866
    .local v19, "card":Lcom/android/internal/telephony/uicc/UiccCard;
    if-eqz v19, :cond_c
    ...
    .line 879
    new-instance v11, Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilter;
    ...
    invoke-direct/range {v11 .. v16}, Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilter;-><init>(Lcom/android/internal/telephony/InboundSmsHandler;[[BILjava/lang/String;Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;)V

    .line 881
    .local v11, "smsFilter":Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilter;
    ...
    invoke-direct {v0, v1, v11}, Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilterCallback;-><init>(Lcom/android/internal/telephony/InboundSmsHandler;Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilter;)V
    ...
    invoke-virtual {v11, v2, v0}, Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilter;->filterSms(Ljava/lang/String;Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilterCallback;)V

    .line 895
    .end local v11    # "smsFilter":Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilter;
    ...
    .line 887
    .restart local v11    # "smsFilter":Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilter;
    new-instance v35, Lcom/android/internal/telephony/InboundSmsHandler$CarrierSmsFilterCallback;
    ...
    invoke-virtual {v0, v13, v2, v14, v10}, Lcom/android/internal/telephony/InboundSmsHandler;->dispatchSmsDeliveryIntent([[BLjava/lang/String;ILandroid/content/BroadcastReceiver;)V
...
.method public sendBlockRecordBroadcast(Landroid/content/Intent;ZLandroid/content/BroadcastReceiver;Ljava/lang/String;I)V
    .locals 16
    .param p1, "intent"    # Landroid/content/Intent;
    .param p2, "isSms"    # Z
    ...
    const-string v1, "com.android.firewall.ADD_SMS_BLOCK_RECORD"
    ...
    invoke-static {v14}, Lcom/android/internal/telephony/InboundSmsHandler;->buildMessageBodyFromPdus([Landroid/telephony/SmsMessage;)Ljava/lang/String;
    ...
    const-string v1, "com.android.firewall.ADD_MMS_BLOCK_RECORD"
    ...
    .line 1482
    .local v13, "blockNumber":Ljava/lang/String;
    invoke-virtual {v2}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;
    ...
    invoke-virtual {v2, v1, v15}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[B)Landroid/content/Intent;
